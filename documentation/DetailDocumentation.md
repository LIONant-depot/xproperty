...
~~~
OBJECT[ Union Variant Properties ]
    MEMBER_VARS[ UnionType ] = ( type: bool, value: true )
    MEMBER_PROPS[ SomeUnion ] = OBJECT[ some_union - as int8 ]
        MEMBER_VARS[ A ] = ( type: s8, value: 1 )
        MEMBER_VARS[ B ] = ( type: s8, value: 2 )
        MEMBER_VARS[ C ] = ( type: s8, value: 3 )
        MEMBER_VARS[ D ] = ( type: s8, value: 4 )
    MEMBER_VARS[ SomeVariantType ] = ( type: Unregistered Enum, value: { VECTOR_BASE1, (1) } )
    MEMBER_PROPS[ SomeVariant ] = OBJECT[ my_variant - as vector of base1 ]
        MEMBER_LIST[ A ] = dimensions( 1 ), count( 2 )
            [ 0 ] key(0) = OBJECT[ Base1 ]
                MEMBER_VARS[ var ] = ( type: s32, value: 20 )
                MEMBER_FUNCTION[ setValues ]
                MEMBER_FUNCTION[ CheckValues ]
...
~~~
Union Variant Properties/UnionType = true
Union Variant Properties/SomeUnion/A = 1
Union Variant Properties/SomeUnion/B = 2
Union Variant Properties/SomeUnion/C = 3
Union Variant Properties/SomeUnion/D = 4
Union Variant Properties/SomeVariantType = VECTOR_BASE1
Union Variant Properties/SomeVariant/A[] = 2
Union Variant Properties/SomeVariant/A[U:0]/var = 20
Union Variant Properties/SomeVariant/A[U:1]/var = 20
~~~
</details>
